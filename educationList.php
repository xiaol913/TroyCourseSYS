...
<head>
    <meta charset="UTF-8">
    <title>Education Courses List</title>
...
<script type="text/javascript">
    ...
    function change(val){
        window.location="educationList.php?order="+val;
    }
    ...
    function search(){
        ...
        if(event.keyCode==13){
            ...
            window.location="educationList.php?keywords="+val;
        }
    }
</script>
</body>
