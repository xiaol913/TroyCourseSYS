...
<!--            内容部分-->
    ...
    <!--                    修改按钮添加editSub()函数,删除添加delSub()-->
                        <td align="center"><input type="button" value="Edit" class="btn edit20x20" onclick="editSub(<?php echo $row['id']; ?>)"><input type="button" value="Delete" class="btn del20x20" onclick="delSub(<?php echo $row['id']; ?>)"></td>
                    </tr>
                <?php endforeach;?>
            </tbody>
            <!--            页码部分-->
