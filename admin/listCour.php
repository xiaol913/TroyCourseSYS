            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <?php foreach($rows as $row):?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="javascript:showDetail(<?php echo $row['id']; ?>)"><i class="fa fa-list-alt"></i>Detail</a>&nbsp;&nbsp;<a href="javascript:editCour(<?php echo $row['id']; ?>)"><i class="fa fa-pencil-square-o"></i>Edit</a>&nbsp;&nbsp;<a href="javascript:delCour(<?php echo $row['id']; ?>)"><i class="fa fa-trash-o"></i>Delete</a>
        <!--                    详情-->
